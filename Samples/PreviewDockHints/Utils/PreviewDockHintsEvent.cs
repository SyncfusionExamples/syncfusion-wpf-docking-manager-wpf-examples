...
namespace DockingManager_PreviewDockHints_Event
{
    ...
    /// </summary>
    class UpdateDockingHints : ICommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            if ((parameter as PreviewDockHintsEventArgs).DraggingTarget.Name == "Output")
            {
                (parameter as PreviewDockHintsEventArgs).DockAbility = DockAbility.Top;
            }
            else if ((parameter as PreviewDockHintsEventArgs).DraggingTarget.Name == "Properties")
            {
                (parameter as PreviewDockHintsEventArgs).DockAbility = DockAbility.Bottom;
            }
        }
        #endregion
    }
